...
namespace LC.SERVICE.Services.Interfaces
{
    public interface ILegalCaseService
    {
        ...
        Task Insert(LegalCase entity);
        Task Update(LegalCase entity);
        Task Delete(LegalCase entity);
        ...
        Task<DataTablesStructs.ReturnedData<object>> GetLegalCasesDatatable(DataTablesStructs.SentParameters parameters, byte? status, byte? type = null, DateTime? dateStart = null, DateTime? dateEnd = null, string search = null);
